...
<head>
    ...
    <title>Sistema de articulos</title>
...
<div class="boton_contenedor_encabezado_page">
  ...
  <div class="modal-content">
    ...
    <h1 class="contenedor-inputs titulo_1">Eliminar articulo</h1> <br> <br>
    <br>
    <h3 class="contenedor-inputs modulo-eliminar-usuarios"> Nombre: <?php echo $Nombre; ?>, con código: <?php echo $Codigo; ?></h3>
    <br> <br>
