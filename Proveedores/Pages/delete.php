...
<form id="deleteForm" action="../Controladores/delete.php" method="post">
        ...
        <h1 class="contenedor-inputs titulo_1">Eliminar proveedor</h1> <br> <br>
        <br>
    <h3 class="contenedor-inputs modulo-eliminar-usuarios"> Nombre: <?php echo $Nombre; ?> y documento: <?php echo $Documento; ?></h3>
    <br> <br>
