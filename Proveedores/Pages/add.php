...
<a class="boton_encabezado" href="#" onclick="mostrarModal();"><i class="fa fa-sign-out-alt"></i></a>
    ...
    <h1 class="contenedor-inputs titulo_1">Registrar proveedor</h1> <br> <br>    
        <p class="input-1">Nombre</p> <br>
        <input class="input-2" type="text" name="Nombre" required="" autocomplete="off" placeholder="Escribe nombre proveedor"> <br><br>
        ...
        <input class="input-2" type="text" name="Documento" required="" autocomplete="off" placeholder="Escribe documento"> <br><br>
        <p class="input-1">Correo</p> <br>
        <input class="input-2" type="email" name="Correo" required="" autocomplete="off" placeholder="Escribe correo"> <br><br>
