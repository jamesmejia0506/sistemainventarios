...
$Modelo = new Inventaristas();
$Id = $_GET['Id']; //Recibimos el id que trigimos por el metodo get y lo guardamos en la variable id

$InformacionInventaristas = $Modelo->getById($Id); //SE CREA UN ARRAY CON TODA LA INFORMACION DEL Inventarista APARTIR DEL ID PORE MEDIO DEL METODO getById QUE LO LLAMO POR MEDIO DEL OBJETO MODELO Inventaristas
...
<a class="boton_encabezado" href="#" onclick="mostrarModal();"><i class="fa fa-sign-out-alt"></i></a>
    ...
    <input type="hidden" name="Id" value="<?php echo $Id;?>">
        ...
        <?php
        if($InformacionInventaristas != null){
            foreach ($InformacionInventaristas as $Informacion){

        
        ?>

        <h1 class="contenedor-inputs titulo_1">Editar inventarista</h1> <br> <br>
    ...
    ?>
        ...
        <input type="submit" value="Guardar" class="contenedor-inputs btn-enviar">
