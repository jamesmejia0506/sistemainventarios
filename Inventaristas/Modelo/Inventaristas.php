...
class Inventaristas extends Conexion {
    ...
    public function add($Nombre, $Apellido, $Usuario, $Password){
        ...
        PASSWORD, PERFIL, ESTADO) VALUES (:Nombre, :Apellido, :Usuario, :Password, 'Inventarista', 'Activo')");
    ...
    //METODO PARA LISTAR LA INFORMACIÓN DE UN SOLO INVENTARISTA POR ID
    public function getById($Id){
        //$rows == null; //Entonces nos traera un arreglo que contendra todos los registros que estan en nuestra base de datos 
        $statement = $this->db->prepare("SELECT * FROM usuarios WHERE PERFIL = 'Inventarista' AND ID_USUARIO = :Id");
    ...
    //METODO PARA ACTUALIZAR UN INVENTARISTA
    ...
    //METODO PARA ELIMINAR UN INVENTARISTA
